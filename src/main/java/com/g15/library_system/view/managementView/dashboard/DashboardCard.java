...
public class DashboardCard extends RoundedPanel {
    ...
    public DashboardCard(String iconPath, String title, String amount,Color backgroundColor, Color iconBackgroundColor,Color borderColor) {
        ...
        viewButton = ButtonGenerator.createCustomButton(
                "View Details",
