...
public class TablePanel extends RoundedPanel implements TransactionObserver {
    ...
    private final TransactionController transactionController = ApplicationContextProvider.getBean(TransactionController.class);
    private final TransactionMapper transactionMapper = ApplicationContextProvider.getBean(TransactionMapperImpl.class);
    ...
    public TablePanel(CardLayout cardLayout, JPanel parentPanel) {
        ...
        addNewButton = CustomButtonBuilder.builder()
                .text("Lend New Book")
