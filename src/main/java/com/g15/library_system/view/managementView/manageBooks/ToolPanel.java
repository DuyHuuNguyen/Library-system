...
public class ToolPanel extends JPanel {
    ...
    ToolPanel() {
        ...
        addBt = CustomButtonBuilder.builder()
                .text("Add Book")
        ...
        addBt.addActionListener(e-> new ToastNotification(JOptionPane.getFrameForComponent(this),
                ToastNotification.Type.SUCCESS, ToastNotification.Location.TOP_CENTER, "New book added successfully!").showNotification());
        actionBtPn.add(addBt);



        mainButton = CustomButtonBuilder.builder()
                .text("Actions")
                .font(Style.FONT_SANS_SERIF_PLAIN_15)
                .textColor(Color.WHITE)
                .backgroundColor(Style.PURPLE_MAIN_THEME)
        ...
        dropdownButton = CustomButtonBuilder.builder()
                .text("▼")
                .font(Style.FONT_SANS_SERIF_PLAIN_15)
                .textColor(Color.WHITE)
                .backgroundColor(Style.PURPLE_MAIN_THEME)
        ...
        int popupWidth = mainButton.getPreferredSize().width + dropdownButton.getPreferredSize().width -2;
        int popupHeight = 35;

        actionMap.put("Edit", () ->new ToastNotification(JOptionPane.getFrameForComponent(this), ToastNotification.Type.INFO, ToastNotification.Location.TOP_CENTER, "editing").showNotification());
        ...
        for (String itemText : items) {
            ...
            item.addActionListener(e -> {
                ...
                mainButton.addActionListener(ev -> {
        ...
        removeBt = CustomButtonBuilder.builder()
                .text("Remove")
                .font(Style.FONT_SANS_SERIF_PLAIN_15)
                .textColor(Color.WHITE)
