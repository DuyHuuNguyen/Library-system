...
public class LenderChartPanel extends RoundedShadowPanel {
    ...
    LenderChartPanel(){
        ...
        JLabel chartTitle = LabelGenerator.createLabel("   Books Lending Trends", Style.FONT_BOLD_18, Color.BLACK,SwingConstants.LEFT);
...
//        revenueChartPanel = new ChartPanel(revenueChart);
    ...
    public class ChartPanel extends JPanel {
        ChartPanel(){
            ...
            JPanel chart = JFreeChartGenerator.createLineChart("","Number of Months","Number of Books borrowed",lendingData);
