...
public class DashBoardPanel extends JPanel {
    ...
    public DashBoardPanel(){
        ...
        TableGenerator.setColorScrollPane(scrollPane, Style.PURPLE_MAIN_THEME, Style.CHART_BACKGROUND_COLOR);
    ...
    public class WelcomePanel extends JPanel{
        WelcomePanel() {
            ...
            AnimatedGradientTextLabel text3 = new AnimatedGradientTextLabel("Hello, " + userName + "!", Style.FONT_BOLD_30,new Dimension(300,50),SwingConstants.LEFT);
            gbc.gridx = 0;
            gbc.weightx = 0;
            ...
            CustomButton operatingNotifyBt = ButtonGenerator.createCustomButton(
            ...
            ButtonGenerator.setButtonIcon("src/main/java/view/LibraryUI/icons/infoYellowIcon.png", operatingNotifyBt, 23);
