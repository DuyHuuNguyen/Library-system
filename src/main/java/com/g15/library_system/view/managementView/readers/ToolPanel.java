...
public class ToolPanel extends JPanel {
  ...
  ToolPanel(ReaderPanel readerPn) {
    ...
    addBt.addActionListener(
        e -> {
          clearTextFields(readerPn.contentPn.showPn.formPn); // Xóa trắng
          enableTextFields(readerPn.contentPn.showPn.formPn, true); // Cho phép nhập
          readerPn.contentPn.showPn.btnPn.setMode(ButtonPanelMode.ADD);
        });
