...
public class UserPanel extends JPanel {
    ...
    public UserPanel() {
        ...
        setBorder(BorderFactory.createTitledBorder(whiteLine,"User Information",0,0, Style.FONT_BOLD_20));
        setOpaque(false);
        init();
    }
    ...
    private void init() {
        ...
        nameL = LabelGenerator.createLabel("Lender Name", Style.FONT_PLAIN_13, Style.WORD_COLOR_BLACK, SwingConstants.LEFT, 0);
        nameTF = TextFieldGenerator.createTextField("", Style.FONT_PLAIN_13, Style.WORD_COLOR_BLACK, Style.PURPLE_MAIN_THEME, new Dimension(200, 25));

        idL = LabelGenerator.createRequireLabel("Membership ID");
        idTF = TextFieldGenerator.createTextField("", Style.FONT_PLAIN_13, Style.WORD_COLOR_BLACK, Style.PURPLE_MAIN_THEME, new Dimension(200, 25));
