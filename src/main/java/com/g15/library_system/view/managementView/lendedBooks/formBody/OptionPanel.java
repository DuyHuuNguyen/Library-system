...
public class OptionPanel extends JPanel {
    ...
    private void init() {
        ...
        notificationL = LabelGenerator.createLabel("Notifications", Style.FONT_PLAIN_13, Style.WORD_COLOR_BLACK, SwingConstants.LEFT, 0);
        notificationSB = new SwitchButton();

        finePolicyL = LabelGenerator.createRequireLabel("Fine Policy");
        fineTF = TextFieldGenerator.createTextFieldWithPlaceholder("Enter Amount",
                Style.FONT_PLAIN_13, Color.GRAY, Style.PURPLE_MAIN_THEME, new Dimension(200, 25));
