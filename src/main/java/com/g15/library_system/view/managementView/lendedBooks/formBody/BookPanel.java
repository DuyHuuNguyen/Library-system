...
public class BookPanel extends JPanel {
    ...
    private void init() {
        ...
        titleL = LabelGenerator.createLabel("Book title", Style.FONT_PLAIN_13, Style.WORD_COLOR_BLACK, SwingConstants.LEFT, 0);
        titleCB = new JComboBox<>(new String[] {"Select form list"});

        isbnL = LabelGenerator.createRequireLabel("ISBN/ISSN");
        isbnTF = TextFieldGenerator.createTextField("978-92-95055-02-5", Style.FONT_PLAIN_13, Style.WORD_COLOR_BLACK, Style.PURPLE_MAIN_THEME, new Dimension(200, 25));
