...
public class LibrarianToolPanel extends JPanel {
    ...
    public LibrarianToolPanel(CardLayout cardLayout, JPanel panelContent, Map<ApiKey, Runnable> mapApi) {
        ...
        reloadBt = CustomButtonBuilder.builder()
                .text("Reload")
                .title("Reload")
                .font(Style.FONT_SANS_SERIF_PLAIN_15)
                .textColor(Color.WHITE)
        ...
        gotoTableBt = CustomButtonBuilder.builder()
                .text("Go to table")
                .title("Go to table")
                .font(Style.FONT_SANS_SERIF_PLAIN_15)
                .textColor(Color.WHITE)
