...
public class ReaderTypesChartPanel extends RoundedShadowPanel implements BookLendedObserver {
  ...
  public ReaderTypesChartPanel() {
    ...
    pieChart = JFreeChartGenerator.createPieChart("", readerStatsData);
