...
public class StudentPanel extends JPanel {
    ...
    public StudentPanel() {
        ...
        // Dòng 1
        gbc.gridx = 0; gbc.gridy = row; infoPanel.add(new JLabel("Full Name:"), gbc);
        gbc.gridx = 1; txtFullName = new JTextField(); infoPanel.add(txtFullName, gbc);

        gbc.gridx = 2; infoPanel.add(new JLabel("Email:"), gbc);
        gbc.gridx = 3; txtEmail = new JTextField(); infoPanel.add(txtEmail, gbc);
        row++;

        // Dòng 2
        gbc.gridx = 0; gbc.gridy = row; infoPanel.add(new JLabel("Date of Birth:"), gbc);
        gbc.gridx = 1; txtDob = new JTextField(); infoPanel.add(txtDob, gbc);

        gbc.gridx = 2; infoPanel.add(new JLabel("Phone:"), gbc);
        gbc.gridx = 3; txtPhone = new JTextField(); infoPanel.add(txtPhone, gbc);
        row++;

        // Dòng 3
        gbc.gridx = 0; gbc.gridy = row; infoPanel.add(new JLabel("Address:"), gbc);
        ...
        gbc.gridx = 1; cbStatus = new JComboBox<>(new String[]{"Active", "Inactive"});
        infoPanel.add(cbStatus, gbc);

        gbc.gridx = 2; infoPanel.add(new JLabel("Student ID:"), gbc);
        gbc.gridx = 3; txtStudentId = new JTextField(); infoPanel.add(txtStudentId, gbc);
        row++;

        // Dòng 5
        gbc.gridx = 0; gbc.gridy = row; infoPanel.add(new JLabel("Enrollment Year:"), gbc);
        gbc.gridx = 1;
        ...
        gbc.gridx = 2; infoPanel.add(new JLabel("Faculty:"), gbc);
        gbc.gridx = 3;
        cbFaculty = new JComboBox<>(new String[]{"IT", "Business", "Law", "Engineering"});
        infoPanel.add(cbFaculty, gbc);

        // === Bảng và nút ===
        tblBorrowedBooks = new JTable(new DefaultTableModel(
                new Object[][]{
