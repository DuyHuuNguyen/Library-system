...
public class ShowPanel extends JPanel {
  public AvatarPanel avtPn = new AvatarPanel();
  public ButtonPanel btnPn = new ButtonPanel(new AvatarPanel(), new FormPanel());
  public FormPanel formPn = new FormPanel();

  public ShowPanel(String btn1, String btn2) {
    // Set up the panel
