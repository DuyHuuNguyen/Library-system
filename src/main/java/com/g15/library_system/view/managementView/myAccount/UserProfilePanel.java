...
public class UserProfilePanel extends RoundedPanel {
    ...
    public UserProfilePanel(String avatarPath, Map<String ,String > personalData, Map<String ,String > addressData) {
    ...
    private void buildViewMode() {
        ...
        addressLabel = new JLabel(addressData.get("Address")+ ", "+ addressData.get("City")+", "+ addressData.get("Country"));
    ...
    public void updateProfileData(Map<String, String> personalData) {
        ...
        addressLabel.setText(addressData.get("Address")+ ", "+ addressData.get("City")+", "+ addressData.get("Country"));
