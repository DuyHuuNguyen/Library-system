...
public class LoginFrame extends JFrame {
  ...
  private class WelcomePanel extends JPanel {
    ...
    public WelcomePanel() {
      ...
      //            welcomeLabel = LabelConfig.createLabel("<html>Welcome to the Library Management
      // System!<br>Enjoy browsing and managing your books.<html>",
    ...
    SignInPanel(LoginFrame loginFrame) {
      ...
      signInLabel =
          LabelGenerator.createLabel(
              "Sign In", Style.FONT_TITLE_BOLD_45, Style.PURPLE_MAIN_THEME, SwingConstants.CENTER);
      //            OutlinedLabel signIn = new OutlinedLabel("Sign
      // In",Style.FONT_TITLE_BOLD_45,Style.PURPLE_MAIN_THEME,new Color(255, 215, 0));
      gbc.gridx = 0;
      gbc.gridy = 0;
      gbc.gridwidth = 2;
      ...
      gbc.gridx = 0;
      JLabel roleIcon =
          LabelGenerator.createImageLabel(
              "src/main/java/view/LibraryUI/icons/roleIcon2.png", 35, 35);
      add(roleIcon, gbc);
      ...
      JLabel nameIcon =
          LabelGenerator.createImageLabel(
              "src/main/java/view/LibraryUI/icons/green_user_icon.png", 30, 30);
      add(nameIcon, gbc);
      ...
      JLabel passwordIcon =
          LabelGenerator.createImageLabel(
              "src/main/java/view/LibraryUI/icons/lockIcon.png", 40, 40);
      ...
      public InputEmail() {
        ...
        sendCodeBt.addActionListener(
            e -> {
              ...
              //                                var manager =
              // COMPUTER_SHOP.findManagerByEmail(email);
              //                                if (manager == null)
              //                                    ToastNotification.showToast("Not found user",
              // 3000, 30, -1, -1);
              //                                name = manager.getFullName();
              //
              //                            } else {
              //                                forgotPasswordStatus =
              // ForgotPasswordStatus.CUSTOMER;
              //                                var customer =
              // COMPUTER_SHOP.findCustomerByEmail(email);
              //                                if (customer == null)
              //                                    ToastNotification.showToast("Not found user",
              // 3000, 30, -1, -1);
        ...
        backBt =
            ButtonGenerator.createCustomButton(
                ...
                SwingConstants.CENTER,
                new Dimension(350, 50));
        backBt.addActionListener(e -> signInMainPn.showPanel("signIn"));
        gbc.gridy++;
        add(backBt, gbc);
      }
    }
      ...
      VerificationCodePanel() {
        ...
        verifyBt.addActionListener(
            e -> {
              ...
              //                                        int num =
              // Integer.parseInt(otpFields[i].getText().trim());
              //                                        otpInput += num;
              //                                        if (i < otpFields.length - 1) otpInput *=
              // 10;
              //                                    }
              ...
              //                                } else {
              //                                    setColorTextField();
              //                                    ToastNotification.showToast("Wrong OTP", 2500,
              // 50, -1, -1);
              //                                }
              showInnerPanel("setNewPasswd");
            });
        ...
        for (int i = 0; i < 4; i++) {
          ...
          otpFields[i].setBorder(BorderFactory.createLineBorder(Style.PURPLE_MAIN_THEME, 1));
      ...
      SetNewPasswdPanel() {
        ...
        backBt =
            ButtonGenerator.createCustomButton(
                ...
                SwingConstants.CENTER,
                new Dimension(320, 50));
        backBt.addActionListener(e -> showInnerPanel("verificationCode"));
