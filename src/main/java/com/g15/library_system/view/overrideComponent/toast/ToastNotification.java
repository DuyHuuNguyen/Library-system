...
public class ToastNotification extends javax.swing.JComponent {
    ...
    private void init(String message) {
        ...
        if (type == Type.SUCCESS) {
            ...
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/toastIcons/info.png")));
            lbMessage.setText("Info");
        } else {
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/toastIcons/warning.png")));
    ...
    lbMessageText.setText("Message Text");
        ...
        cmdClose.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/toastIcons/close.png")));
