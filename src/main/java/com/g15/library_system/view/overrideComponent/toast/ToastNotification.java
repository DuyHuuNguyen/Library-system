package com.g15.library_system.view.overrideComponent.toast;
...
public class ToastNotification extends javax.swing.JComponent {
  ...
  private Type type;
  private Location location; // Location where the notification will show up
  ...
  public ToastNotification(Frame frame, Type type, Location location, String message) {
    this.frame = frame;
    this.type = type;
  ...
  private void init(String message) {
    ...
    if (type == Type.SUCCESS) {
      ...
      lbIcon.setIcon(
          new javax.swing.ImageIcon(getClass().getResource("/icons/toastIcons/info.png")));
      lbMessage.setText("Info");
    } else {
      lbIcon.setIcon(
          new javax.swing.ImageIcon(getClass().getResource("/icons/toastIcons/warning.png")));
  ...
  private BufferedImage createShadow() {
    BufferedImage img =
        new BufferedImage(
            getWidth() - shadowSize * 2, getHeight() - shadowSize * 2, BufferedImage.TYPE_INT_ARGB);
  ...
  private void initComponents() {
    ...
    cmdClose.setIcon(
        new javax.swing.ImageIcon(getClass().getResource("/icons/toastIcons/close.png")));
