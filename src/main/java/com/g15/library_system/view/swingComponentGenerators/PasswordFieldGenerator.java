...
public class PasswordFieldGenerator {
   ...
   * @return
   */
  public static JPasswordField createPasswordField(String text, Font font, Dimension size) {
  ...
  public static void addFocusListenerPasswdField(
      JPasswordField that, String originText, Color borderColor) {
    that.addFocusListener(
        new FocusListener() {
          ...
          public void focusGained(FocusEvent e) {
            ...
            that.setBorder(BorderFactory.createLineBorder(borderColor, 3));
          }
          ...
          public void focusLost(FocusEvent e) {
            ...
            that.setBorder(BorderFactory.createLineBorder(borderColor, 1));
          }
        });
  }
