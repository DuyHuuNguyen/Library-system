  ...
  public static JPanel createIconPanel(String messageType) {
    ...
    switch (messageType) {
      case SUCCESS:
        ...
        LabelGenerator.setIcon(
            iconLabel, "src/main/java/view/LibraryUI/icons/tickIcon.png", 40, 40);
        break;
      case REMOVED:
        panel.setBackground(Style.LIGHT_BLUE);
        borderColor = Style.CONFIRM_BUTTON_COLOR_GREEN;
        LabelGenerator.setIcon(
            iconLabel, "src/main/java/view/LibraryUI/icons/removeIconTrashBin.png", 40, 40);
        break;
      case ERROR:
        panel.setBackground(Style.LIGHT_RED_2);
        borderColor = Style.CANCEL_BUTTON_COLOR_RED;
        LabelGenerator.setIcon(
            iconLabel, "src/main/java/view/LibraryUI/icons/error_icon.png", 40, 40);
        break;
      case WARNING:
        panel.setBackground(Style.LIGHT_YELLOW_2);
        borderColor = Style.YELLOW_DARKER;
        LabelGenerator.setIcon(
            iconLabel, "src/main/java/view/LibraryUI/icons/warningIcon.png", 40, 40);
        break;
      case INFORMATION:
        panel.setBackground(Style.LIGHT_BLUE);
        borderColor = Style.BUTTON_COLOR;
        LabelGenerator.setIcon(
            iconLabel, "src/main/java/view/LibraryUI/icons/informationIcon.png", 40, 40);
        break;
      default:
